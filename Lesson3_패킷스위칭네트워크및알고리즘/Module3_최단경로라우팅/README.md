...
- countig-to-infinity 문제 방지를 위해 거리 벡터 알고리즘에 몇가지 변경 사항
...
- 일반적으로 벨만-포드 알고리즘보다 효율적이지만, 통신 네트워크의 경우 각 링크 비용이 양수가 됨
### Idea and Procedure
...
- 다중 프로토콜 레이블 스위칭 MPLS는 패킷 네트워크를 위한 대체 네트워크 기술로 도입됨
